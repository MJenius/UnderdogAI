...
import { AlertCircle, Play, RefreshCw, BarChart2, Shield, Calendar, Users, List } from "lucide-react";
...
export default function Home() {
  ...
  }, [selectedYear, fetchDarkHorses, fetchTeams]);
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-6 py-8 flex flex-col gap-8">
        ...
        <section className="flex-grow">
          ...
          {activeTab === "upset-matrix" && (
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h2 className="text-2xl font-bold tracking-tight text-white">Match-Level Upset Calculator</h2>
                <p className="text-zinc-400 max-w-3xl text-sm">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1 border border-zinc-800 bg-zinc-900/30 rounded-2xl p-6 flex flex-col gap-6">
                  ...
                  <div className="border-t border-zinc-800 pt-6 flex flex-col gap-4">
                    <div className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Point-in-Time Priors</div>
                ...
                <div className="lg:col-span-2 border border-zinc-800 bg-zinc-900/10 rounded-2xl p-6 flex flex-col justify-center items-center">
                  {prediction ? (
                    <div className="w-full flex flex-col gap-8">
                      <div>
                        <h3 className="text-lg font-bold text-white mb-6">Outcome Probability Distributions</h3>
                        <div className="flex flex-col gap-4">
                      ...
                      <div className="border-t border-zinc-800/80 pt-8 flex flex-col sm:flex-row items-center gap-6">
                        <div className="h-24 w-24 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex flex-col justify-center items-center shrink-0">
                          <div className="text-3xl font-extrabold text-indigo-400">{(upsetRisk * 100).toFixed(0)}%</div>
                          <div className="text-[10px] font-bold text-indigo-300 uppercase tracking-widest mt-1">Upset Risk</div>
                        </div>
                    ...
                    <div className="text-center py-12 flex flex-col items-center gap-3">
                      ...
                      <div className="text-sm font-semibold text-zinc-400">Select teams and run calculations to see distributions.</div>
                    </div>
                  )}
                </div>
              </div>
                  ...
                  {simLoading ? (
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
                        <h3 className="text-lg font-bold text-white">Tournament Winner Probabilities</h3>

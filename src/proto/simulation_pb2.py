...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SIMULATIONTASKSTATUS']._serialized_end=417
  _globals['_SIMULATIONSERVICE']._serialized_start=420
  _globals['_SIMULATIONSERVICE']._serialized_end=625
